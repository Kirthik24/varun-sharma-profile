...
<path d="M60.4444 7.60069H44.6533C43.8798 5.37938 42.4391 3.45477 40.5305 2.0931C38.622 0.731427 36.3399 0 34 0C31.6601 0 29.378 0.731427 27.4695 2.0931C25.5609 3.45477 24.1202 5.37938 23.3467 7.60069H7.55556C5.55354 7.60671 3.63522 8.40934 2.21958 9.8333C0.803929 11.2573 0.00597919 13.1868 0 15.2006V68.4001C0.00597919 70.4138 0.803929 72.3434 2.21958 73.7674C3.63522 75.1914 5.55354 75.994 7.55556 76H60.4444C62.4465 75.994 64.3648 75.1914 65.7804 73.7674C67.1961 72.3434 67.994 70.4138 68 68.4001V15.2006C67.994 13.1868 67.1961 11.2573 65.7804 9.8333C64.3648 8.40934 62.4465 7.60671 60.4444 7.60069ZM34 7.60069C34.7472 7.60069 35.4776 7.82356 36.0988 8.2411C36.7201 8.65865 37.2043 9.25212 37.4902 9.94647C37.7761 10.6408 37.851 11.4049 37.7052 12.142C37.5594 12.8791 37.1996 13.5562 36.6713 14.0876C36.143 14.6191 35.4698 14.981 34.737 15.1276C34.0042 15.2742 33.2446 15.199 32.5543 14.9114C31.864 14.6238 31.274 14.1367 30.8589 13.5118C30.4438 12.8869 30.2222 12.1522 30.2222 11.4007C30.2252 10.3938 30.6242 9.42898 31.332 8.717C32.0398 8.00502 32.999 7.6037 34 7.60069ZM26.4444 26.6005L36.9844 37.2176L46.5044 27.6417L41.5556 22.8005H56.6667V38.0004L51.8462 33.0186L36.992 47.9715L26.4444 37.3544L16.6751 47.1735L11.3333 41.8003L26.4444 26.6005ZM60.4444 64.6001H7.55556V57.0002H60.4444V64.6001Z" fill="#2D5186"/>
</svg>
...
rapid tooling <br />
Funding Agency - Aeronautical Research
Development Board
(ARDB/DRDO) <br />
Amount
(Rs.) - 27,75,460 <br />
Duration - 3 Years (Completed)
                   ...
                   <li>
                   Ultrasonic-assisted grinding of
difficult-to-cut materials with
ultrasonically atomized green
solvents <br />
Funding Agency - Council of Scientific
&amp; Industrial Research
(CSIR) <br />
Amount
(Rs.) - 25,60,000 <br />
Duration - 3 Years (Completed)
                   ...
                   <li>
                   Investigations into bio-
ceramic-based poly (D, L-
lactide) composite scaffold
using stereolithography <br />
Funding Agency - Science and
...
lactide) composite scaffold
using stereolithography <br />
Funding Agency - Uttarakhand State
Council for Science &
Technology (UCOST) <br />
Amount
(Rs.) - 3,68,000 <br />
...
system <br />
Funding Agency - India Egypt S T <br />
Cooperation
Amount
(Rs.) - 11,10,000 <br />
...
Funding Agency - FIG, IIT Roorkee <br />
Amount
(Rs.) - 20,00,000 <br />
Duration - 3 Years (Completed)</li>
        ...
        <div className="para">
            ...
            <div className="points">
                <ul>
                    <li>
                    Studies on improving the
efficacy of hydraulic machine <br />
...
in turning process <br />
Students - Anshul Bajpai, Gautam
Singla, Tanmay Maheshwari <br />
Year - 2018 (Completed)
                    </li>
                    <li>
                    Exploration of nano-fluids during
...
Akshay Antony, Devinder Kumar Singh<br />
Year - 2021 (Completed)</li>
...
Indian thermal power plants<br />
...
Co specimen using machine learning<br />
Students - Abhishek Paliwal, Dushyant
Yadav, Vishal Yadav,
Kaushal<br />
Year - 2022 (In-progress)</li>
                    <li>Design and development of projection
based micro-stereolithography setup<br />
Students - Prathamesh Bhaktan<br />
Year - 2022 (In-progress)</li>
                </ul>
