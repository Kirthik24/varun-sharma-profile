    ...
    <div className="container">
        ...
        <div className="person">
            <img src={mtech1} alt="" />
                <div className="details">
                    ...
                    <span> <p>Email - <a href="mailto: neeteshkumar4109@gmail.com"><span>neeteshkumar4109@gmail.com</span></a></p> 
                    <p>Contact No. - +91-9523054117</p> </span>
                </div>
        </div>
        ...
        <div className="person">
            <img src={mtech2} alt="" />
                ...
                <span> <p>Email - <a href="mailto: shubham.mohol93@gmail.com"><span>shubham.mohol93@gmail.com</span></a></p> 
                <p>Contact No. - +91-9730474081</p></span>
                </div>
        </div>
        ...
        <div className="person">
            <img src={mtech3} alt="" />
                ...
                <span>
                    ...
                    <span> <p>Email - <a href="mailto: m_meena@me.iitr.ac.in"><span>m_meena@me.iitr.ac.in</span></a></p> 
                    <p>Contact No. - +91-7891781033</p></span>
                </div>
        </div>
        ...
        <div className="person">
            <img src={mtech4} alt="" />
                ...
                <span>
                    ...
                    <span> <p>Email - <a href="mailto: surenmechanic@gmail.com"><span>surenmechanic@gmail.com</span></a></p> 
                    <p>Contact No. - +91-8526143224</p></span>
                </div>
        </div>
